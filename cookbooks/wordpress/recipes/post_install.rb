...
execute 'Finish Wordpress installation' do
  command 'sudo -u vagrant -i -- wp core install --path=/opt/wordpress/ --url=192.168.56.2 --title="DevOps - Deployment Automation Tools" --admin_user=admin --admin_password="admin123" --admin_email=admin@example.com'
